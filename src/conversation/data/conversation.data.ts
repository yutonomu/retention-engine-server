...
export const conversationData: Conversation[] = [
  {
    ...
    last_active_at: new Date('2025-01-01T09:00:00Z'),
  },
  {
    conv_id: 'conv-002',
    owner_id: 'user-002',
    ...
    last_active_at: new Date('2025-01-05T08:15:00Z'),
  },
  {
    conv_id: 'conv-003',
    owner_id: 'user-003',
    ...
    last_active_at: new Date('2025-01-08T10:20:00Z'),
  },
  {
    conv_id: 'conv-004',
    owner_id: 'user-005',
    ...
    last_active_at: new Date('2025-01-03T11:45:00Z'),
  },
  {
    conv_id: 'conv-005',
    owner_id: 'user-001',
    ...
    last_active_at: new Date('2024-12-28T13:30:00Z'),
  },
];
